...
export const Route = createFileRoute("/locations/cambridge")({
  head: () => ({
    meta: [
...
const neighborhoods = ["Galt (Downtown Cambridge)", "Preston", "Hespeler", "Blair", "Glen Morris", "Riverside Park", "Shady Acres"];
    ...
    <PageShell>
      <section className="pt-40 pb-20" style={{ background: "#F5F0E6" }}>
        <div className="mx-auto max-w-7xl px-6">
          <Reveal><div className="flex items-center gap-2 text-xs uppercase tracking-[0.25em] text-[#B52E32]"><MapPin size={14} /><span>Serving Cambridge, Ontario</span></div></Reveal>
          <Reveal delay={0.1}><h1 className="mt-4 max-w-4xl font-display text-5xl leading-[1.05] text-balance text-[#202321] md:text-7xl">Professional Painters in <span className="italic text-[#C6A15B]">Cambridge</span>, ON</h1></Reveal>
          <Reveal delay={0.2}><p className="mt-6 max-w-2xl text-lg text-[#687967]">Cambridge's trusted painting experts. Serving Galt, Preston, and Hespeler with premium interior painting, durable exterior coatings, and complete home renovations. Licensed and insured.</p></Reveal>
          <Reveal delay={0.3}>
      ...
      <section style={{ background: "#FFFDF8" }}>
        <div className="mx-auto max-w-7xl px-6 py-28">
          <Reveal><h2 className="font-display text-4xl md:text-5xl text-balance text-[#202321]">Cambridge Areas We Serve</h2></Reveal>
        ...
        <Reveal>
          <div className="px-8 py-20" style={{ borderRadius: "1.5rem", background: "linear-gradient(135deg, #35483A 0%, #202321 100%)" }}>
            <div className="grid items-center gap-8 md:grid-cols-[1fr_auto]">
              <div><h2 className="font-display text-4xl text-[#F5F0E6]">Cambridge homeowners trust Sudcan</h2><p className="mt-4 text-[#687967]">Free quotes for Galt, Preston & Hespeler. Same-day response.</p></div>
